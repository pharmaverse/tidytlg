...
test_that("tablebyvar tables can be binded together", {
  ...
  expect_equal(
    bind_table(mtcars3, mtcars4, colvar = "am", tablebyvar = "gear", prefix = "Car Gears: "),
    expected,
    ignore_attr = TRUE
  )
  ...
  expect_equal(
    bind_table(mtcars3, mtcars4, colvar = "am", tablebyvar = "gear", prefix = "Car Gears: ", add_count = TRUE),
    expected,
    ignore_attr = TRUE
  )
})
...
test_that("rowbyvar creates tables as expected", {
  ...
  expect_equal(
    read_sas("test_data/adsl.sas7bdat") %>%
      freq(colvar = "TRT01A", rowvar = "SEX", rowbyvar = c("RACE", "COMP8FL"), .ord = TRUE, .keep = TRUE),
    expected,
    ignore_attr = TRUE
  )
})
...
test_that("default denoms_by is set properly", {
  ...
  expect_equal(
    freq(
      mtcars,
      colvar = "am", rowvar = "cyl", rowbyvar = "gear", statlist = statlist(c("n/N (x.x%)"), distinct = FALSE)
    ),
    expected,
    ignore_attr = TRUE
  )
  ...
  expect_equal(
    freq(
      ...
      rowvar = "cyl",
      rowbyvar = "gear",
      statlist = statlist(c("n/N (x.x%)"), distinct = FALSE)
    ),
    expected,
    ignore_attr = TRUE
  )

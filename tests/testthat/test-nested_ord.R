...
test_that("nested tables work with .ord as expected", {
  ...
  expect_equal(nested_freq(mtcars2, colvar = "gear", rowvar = "grp*cyl", .ord = TRUE), expected, ignore_attr = TRUE)
  ...
  expect_equal(
    nested_freq(mtcars2, colvar = "gear", rowvar = "grp*grp2*cyl", .ord = TRUE), expected,
    ignore_attr = TRUE
  )
})

...
We will use the adsl data from the [PHUSE Test Data Factory](https://github.com/phuse-org/TestDataFactory/raw/main/Updated/TDF_ADaM) to illustrate the creation of a demographic table.
